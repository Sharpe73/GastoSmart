...
function Liquidaciones() {
  ...
  const subirLiquidacion = async () => {
    if (!archivo || !mes || !anio)
      return alert("Selecciona mes, año y archivo");
  ...
  return (
    <Container sx={{ mt: 4 }}>
      ...
      <Box
        sx={{
          display: "flex",
          flexDirection: isMobile ? "column" : "row", // 📱 en móviles en columna
            ...
            <Grid item xs={12} sm={6} md={3} key={liq.id}>
              <Card
                sx={{
                  boxShadow: 2,
                  borderRadius: 2,
                  maxWidth: isMobile ? "100%" : 200, // 📱 ocupar ancho total en móviles
                  mx: "auto",
